...
class Master(MainAPI):
    ...
    def get_storage_volume(self, backup_id, **kwargs):
    ...
    def create_storage_volume(self, server_id, backup_plan, region, **kwargs):
    ...
    def update_storage_volume(self, backup_id, **kwargs):
    ...
    def remove_storage_volume(self, backup_id):
